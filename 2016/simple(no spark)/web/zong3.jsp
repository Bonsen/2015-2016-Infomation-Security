...
<!-- 						<li>Static Table</li>	 --> 
					...
					<h3 class="header-text m-top-lg">刘志摩-</h3>
					<h1 class="page-header" >基础信息</h1>
					<div  class="head-pic">
						<img src="http://tva3.sinaimg.cn/crop.1.0.509.509.180/60e53d77jw8f5iv5s4cnlj20e80e5mxk.jpg" class="img-circle" style="width:100px">
							<h3 style="color:white">刘志摩-</h3>
             		</div>
                      ...
                      option = {
                        ...
                        series : [
                            
                            {
                                ...
                                data:[70,54,48,51,52,44,69,88,70,77,90,111],
                                markPoint : {
                                          data : [
                                              {type : 'max', name: '最大值'}
                                ...
                                series : [
                                    {
                                        ...
                                        data : [
                                            ...
                                            {name:'正面微博', value:64,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'原创比例', value:82,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'转发比例', value:29,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
