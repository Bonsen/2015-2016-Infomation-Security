                    ...
                    function(ec){
                        ...
                        option = {
                          ...
                          xAxis: [
                              {
                                  type: 'category',
                                  data: ['你家小斌 ', '吉吉的菩提', '-你喺做乜 ', '恍如隔世是你', '雨天濛濛濛', 'Leo兄丶 ', 'Ch-cure ', '库克壹壹零 ']
                              }
                          ],
                          yAxis: [
                              {
                          ...
                          series: [
                              {
                                  ...
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [432,123,122,108,66,164,97,59]
                              },
                              {
                                  name: '转发数',
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [489,166,144,123,57,149,122,54]
                              },
                              {
                                  name: '评论数',
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [498,102,123,174,178,40,34,33]
                              }
                          ]
                      };
                          ...
                          series : [
                              {
                                  ...
                                  nodes:[
                                      ...
                                      {category:1, name: '你家小斌',value : 2},
                                      {category:1, name: '吉吉的菩提',value : 3},
                                      {category:1, name: '-你喺做乜',value : 3},
                                      {category:1, name: '雨天濛濛濛',value : 7},
                                      {category:2, name: '恍如隔世是你',value : 5},
                                      {category:2, name: 'Leo兄丶',value : 8},
                                      {category:2, name: 'Ch-cure',value : 9},
                                      {category:2, name: '库克壹壹零',value : 4},
                                      
                                  ],
                                  links : [
                                      {source : '你家小斌', target : '博主', weight : 2},
                                      {source : '你家小斌', target : 'Ch-cure', weight : 2},
                                      {source : '吉吉的菩提', target : '博主', weight : 2},
                                      {source : '-你喺做乜', target : '博主', weight : 1},
                                      {source : '雨天濛濛濛', target : '博主', weight : 2},
                                      {source : '恍如隔世是你', target : '博主', weight : 3},
                                      {source : 'Leo兄丶', target : '博主', weight : 1},
                                      {source : 'Ch-cure', target : '博主', weight : 3},
                                      {source : '库克壹壹零', target : '博主', weight : 1},
                                      {source : 'Leo兄丶', target : '雨天濛濛濛', weight : 1},
                                      {source : 'Ch-cure', target : 'Leo兄丶', weight : 6},
                                      {source : 'Ch-cure', target : '-你喺做乜', weight : 1},
                                      {source : '库克壹壹零', target : 'Leo兄丶', weight : 1}
                                  ]
                              }
                          ]
                      };
