...
<!-- 						<li>Static Table</li>	 --> 
					...
					<h3 class="header-text m-top-lg">赵迪迪楚楚</h3>
					<h1 class="page-header" >基础信息</h1>
					<div  class="head-pic">
						<img src="http://tva2.sinaimg.cn/crop.1.0.747.747.180/88976dccjw8f3gvhpy3qaj20ku0kr74i.jpg" class="img-circle" style="width:100px">
							<h3 style="color:white">赵迪迪楚楚</h3>
             		</div>
                      ...
                      option = {
                        ...
                        series : [
                            
                            {
                                ...
                                data:[40,19,33,54,30,21,37,47,70,11,29,30],
                                markPoint : {
                                          data : [
                                              {type : 'max', name: '最大值'}
                                ...
                                series : [
                                    {
                                        ...
                                        data : [
                                            ...
                                            {name:'正面微博', value:34,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'原创比例', value:72,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'转发比例', value:28,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
