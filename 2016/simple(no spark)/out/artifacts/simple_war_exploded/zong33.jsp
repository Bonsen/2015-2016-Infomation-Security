                    ...
                    function(ec){
                        ...
                        option = {
                          ...
                          xAxis: [
                              {
                                  type: 'category',
                                  data: ['killer-jrm ', 'Sara秋', '樱木ww ', '天野_痴梦人', 'jessychen', '荆鲸鲸 ', '雷做咩- ', '海老名caicai ']
                              }
                          ],
                          yAxis: [
                              {
                          ...
                          series: [
                              {
                                  ...
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [373,133,121,74,84,93,67,77]
                              },
                              {
                                  name: '转发数',
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [213,154,122,143,52,69,51,41]
                              },
                              {
                                  name: '评论数',
                                  type: 'bar',
                                  itemStyle: itemStyle,
                                  data: [423,123,214,63,106,54,93,62]
                              }
                          ]
                      };
                          ...
                          series : [
                              {
                                  ...
                                  nodes:[
                                      ...
                                      {category:1, name: 'killer-jrm',value : 2},
                                      {category:1, name: 'Sara秋',value : 3},
                                      {category:1, name: '樱木ww',value : 3},
                                      {category:1, name: 'jessychen',value : 7},
                                      {category:2, name: '天野_痴梦人',value : 5},
                                      {category:2, name: '荆鲸鲸',value : 8},
                                      {category:2, name: '雷做咩-',value : 9},
                                      {category:2, name: '海老名caicai',value : 4},
                                      
                                  ],
                                  links : [
                                      {source : 'killer-jrm', target : '博主', weight : 2},
                                      {source : 'killer-jrm', target : 'Sara秋', weight : 2},
                                      {source : 'killer-jrm', target : '雷做咩-', weight : 2},
                                      {source : 'Sara秋', target : '博主', weight : 2},
                                      {source : '樱木ww', target : '博主', weight : 1},
                                      {source : 'jessychen', target : '博主', weight : 2},
                                      {source : '天野_痴梦人', target : '博主', weight : 3},
                                      {source : '荆鲸鲸', target : '博主', weight : 1},
                                      {source : '雷做咩-', target : '博主', weight : 4},
                                      {source : '海老名caicai', target : '博主', weight : 1},
                                      {source : '荆鲸鲸', target : 'jessychen', weight : 1},
                                      {source : '雷做咩-', target : '荆鲸鲸', weight : 2},
                                      {source : '雷做咩-', target : '樱木ww', weight : 1},
                                      {source : '海老名caicai', target : '荆鲸鲸', weight : 1}
                                  ]
                              }
                          ]
                      };
