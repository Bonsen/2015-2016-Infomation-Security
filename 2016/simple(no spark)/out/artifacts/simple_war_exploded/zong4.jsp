...
<!-- 						<li>Static Table</li>	 --> 
					...
					<h3 class="header-text m-top-lg">倔强的执着LJ</h3>
					<h1 class="page-header" >基础信息</h1>
					<div  class="head-pic">
						<img src="http://tva3.sinaimg.cn/crop.0.0.511.511.180/a33c45d0jw8eyouf4v0kbj20e70e8aap.jpg" class="img-circle" style="width:100px">
							<h3 style="color:white">倔强的执着LJ</h3>
             		</div>
                      ...
                      option = {
                        ...
                        series : [
                            
                            {
                                ...
                                data:[33,39,48,51,52,40,30,32,49,38,20,23],
                                markPoint : {
                                          data : [
                                              {type : 'max', name: '最大值'}
                                ...
                                series : [
                                    {
                                        ...
                                        data : [
                                            ...
                                            {name:'正面微博', value:32,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'原创比例', value:77,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
                                        ...
                                        data : [
                                            ...
                                            {name:'转发比例', value:23,itemStyle : labelTop}
                                        ]
                                    },
                                    {
                                        type : 'pie',
